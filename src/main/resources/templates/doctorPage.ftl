                                ...
                                <form role="form" action="/doctorPage/patientPageForDoctor" method="post">
                                    <table class="table">
                                        ...
                                        <tr><#list patients as patient>
                                            ...
                                            <td><a name="patientFullName"
                                                   href="/doctorPage/patientPageForDoctor?patientSurname=${patient.surname}&patientName=${patient.name}&patientPatronymic=${patient.patronymic}">
